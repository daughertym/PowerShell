...
.SYNOPSIS
Get BIOS version on one or more computers.

.PARAMETER ComputerName
Specifies the computer(s) to BIOS version on.
...
.EXAMPLE
Get-Content C:\computers.txt | .\Get-BiosVersion

.EXAMPLE
.\Get-BiosVersion (Get-Content C:\computers.txt) -InvokeParallel

.EXAMPLE
.\Get-BiosVersion (Get-Content C:\computers.txt) -InvokeParallel -IncludeError
            ...
            foreach ($Computer in $ComputerName) {
                ...
                if (Test-Connection -ComputerName $Computer -Count 1 -Quiet) {
                    ...
                    try {
                        ...
                        $Result.Manufacturer = $InvokeResult.Manufacturer

                        $Result.BiosVersion = $InvokeResult.BiosVersion
